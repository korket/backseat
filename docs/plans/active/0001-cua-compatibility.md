...
Open items: production wrapper work proceeds under `docs/plans/active/0004-session-layer.md`; the core contracts and the Cua CLI adapter are completed in `docs/plans/completed/0002-core-contracts.md` and `docs/plans/completed/0003-cua-cli-adapter.md`. `docs/decisions/0004-foreground-input-policy.md` is accepted.
